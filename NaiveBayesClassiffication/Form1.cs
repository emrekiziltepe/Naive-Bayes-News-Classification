...
namespace NaiveBayesClassiffication
{
    public partial class Form1 : Form
    {
        ...
        private void ReadDirectoryFolders()
        {
            ...
            directoryFoldersInfo = DirectoryHelper.GetSubCategories(@"C:\Users\ek-19\Desktop\1150haber\1150haber\raw_texts");
        ...
        private void ReadDirectoryTwoGrams(string category)
        {
            ...
            lblCountLearnGram2.Invoke((MethodInvoker)(() => lblCountLearnGram2.Text = "Toplam : " + resultGramsLearn.Count.ToString()));
            lblCountPredictionGram2.Invoke((MethodInvoker)(() => lblCountPredictionGram2.Text = "Toplam : " + resultGramsPrediction.Count.ToString()));
        ...
        private void ReadDirectoryThreeGrams(string category)
        {
            ...
            lblCountLearnGram3.Invoke((MethodInvoker)(() => lblCountLearnGram3.Text = "Toplam : " + resultGramsLearn.Count.ToString()));
            lblCountPredictionGram3.Invoke((MethodInvoker)(() => lblCountPredictionGram3.Text="Toplam : "+ resultGramsPrediction.Count.ToString()));
        ...
        private void ReadFormula(string category, Label lblPrecision, Label lblRecall, Label lblFeMeasure)
        {
            ...
            lblPrecision.Invoke((MethodInvoker)(() => lblPrecision.Text = "Precision : " + formula.Precision.ToString()));
            lblRecall.Invoke((MethodInvoker)(() => lblRecall.Text = "Re-call : " + formula.ReCall.ToString()));
            lblFeMeasure.Invoke((MethodInvoker)(() => lblFeMeasure.Text = "Fe-measure : " + formula.FeMeasure.ToString()));
        }
        ...
        private void CleanGrams()
        {
            ...
            lblCountLearn.Text = "Toplam : 0";
            lblCountLearnGram2.Text = "Toplam : 0";
            lblCountLearnGram3.Text = "Toplam : 0";
            lblCountPrediction.Text = "Toplam : 0";
            lblCountPredictionGram2.Text = "Toplam : 0";
            lblCountPredictionGram3.Text = "Toplam : 0";
